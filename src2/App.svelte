<script lang="ts">
  ...
  import { pointerStyle } from "../src/lib/components/Styles.svelte";
  import { booped, boops } from "../src/lib/components/Boops";
  import Boops from "../src/lib/components/Boops.svelte";
  import {
    saveState,
    loadState,
    resetState,
