import type { DevelopmentBase, DevelopmentType } from "./backend/classes/franchise/developments/developmentbase";
import type { ClimateType } from "./backend/classes/franchise/region";
